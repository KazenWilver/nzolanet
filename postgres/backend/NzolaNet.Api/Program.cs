...
// Render (e outros PaaS) injectam PORT — a API tem de escutar em 0.0.0.0
...
// 1. Configura a ligação à Base de Dados com EF Core e PostgreSQL (Supabase / Neon)
...
builder.Services.AddSingleton<IAdminMetricsBroadcaster, SignalRAdminMetricsBroadcaster>();
...
// Em PaaS (Render) o TLS termina no proxy — evita redirect HTTPS interno
...
// Health check para keep-alive (UptimeRobot / cron-job.org)
